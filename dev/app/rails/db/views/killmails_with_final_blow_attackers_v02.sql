SELECT  Killmails.killmail_time, Characters.name AS victim_name, Corporations.name AS victims_corporation, Corporations.corporation_id AS victims_corporation_id, 
